  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {employees.map((employee) => (
        <div key={employee.id} className="bg-white rounded-card p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className={`w-2 h-2 rounded-full bg-status-${employee.status.toLowerCase().replace(' ', '')}`} />
